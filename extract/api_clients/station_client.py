...
# using the Overpass API to query OpenStreetMap data. The results are saved in a
# parquet file named "station-coordinates.parquet".
...
def generate_stations_list():
    ...
    df.to_parquet("station-coordinates.parquet", index=False)